...
if len(sys.argv) < 2:
    ...
    # create ssd net
    net = create_ssd(backbone_type, header_type, use_gray, len(class_names)+1, aspect_ratios, priors, center_variance, size_variance, is_test=False, device=torch.device("cpu"))
