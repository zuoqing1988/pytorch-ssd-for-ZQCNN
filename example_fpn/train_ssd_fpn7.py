...
from core.ssd_fpn.ssd_fpn_base import MatchPrior3
...
if __name__ == '__main__':
    ...
    target_transform = MatchPrior3(priors, center_variance, size_variance, args.iou_thresh, args.iou_thresh_mid, args.iou_thresh_low)
    ...
    criterion = MultiboxLoss7(priors, neg_pos_ratio_mid=1,neg_pos_ratio_low=1,
