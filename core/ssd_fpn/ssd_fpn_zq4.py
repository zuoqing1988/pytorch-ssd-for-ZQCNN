...
class SSD_FPN_ZQ4(nn.Module):
    def __init__(self, use_gray, num_classes: int, aspect_ratios,
        ...
        """
        super(SSD_FPN_ZQ4, self).__init__()
        ...
        self.layers = [{'in_c':in_c, 'out_c':16, 'stride':2},
                       {'in_c':16, 'out_c':16, 'stride':1},
        ...
        self.regression_headers = ModuleList([
            conv_dw_bn_relu_sep_bn_relu_sep(self.ori_feature_channels[0], num_boxes*4, 128, 1, 'loc_0'),
        ...
        self.classification_headers = ModuleList([
            conv_dw_bn_relu_sep_bn_relu_sep(self.ori_feature_channels[0], num_boxes*num_classes, 128, 1, 'cls_0'),
