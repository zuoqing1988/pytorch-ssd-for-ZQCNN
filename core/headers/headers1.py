...
def headers1(backbone, num_classes, aspect_ratios):
    ...
    regression_headers = ModuleList([
        ...
        SeperableConv2d(in_channels=128, out_channels=num_boxes * 4, kernel_size=3, stride=1, padding=1, name='loc_3'),
        SeperableConv2d(in_channels=64, out_channels=num_boxes * 4, kernel_size=3, stride=1, padding=1, name='loc_4'),
        Conv_2d(in_channels=64, out_channels=num_boxes * 4, kernel_size=1, stride=1, padding=0, name='loc_5'),
    ])
    ...
    classification_headers = ModuleList([
        ...
        SeperableConv2d(in_channels=128, out_channels=num_boxes * num_classes, kernel_size=3, stride=1, padding=1, name='cls_3'),
        SeperableConv2d(in_channels=64, out_channels=num_boxes * num_classes, kernel_size=3, stride=1, padding=1, name='cls_4'),
        Conv_2d(in_channels=64, out_channels=num_boxes * num_classes, kernel_size=1, stride=1, padding=0, name='cls_5'),
    ])
