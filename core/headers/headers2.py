...
def headers2(backbone, num_classes, aspect_ratios):
    ...
    extras = ModuleList([
        Sequential(OrderedDict([
            ('conv15_1x1', Conv2d(in_channels=backbone.layers[-1]['out_c'], out_channels=128, kernel_size=1)),
            ('conv15_1x1/relu', ReLU()),
            ('conv15_3x3', SeperableConv2d(in_channels=128, out_channels=256, kernel_size=3, stride=2, padding=1, name='conv15_3x3'))
            ])
        ),
        Sequential(OrderedDict([
            ('conv16_1x1', Conv2d(in_channels=256, out_channels=64, kernel_size=1)),
            ('conv16_1x1/relu', ReLU()),
            ('conv16_3x3', SeperableConv2d(in_channels=64, out_channels=128, kernel_size=3, stride=2, padding=1, name='conv16_3x3'))
            ])
        ),
        Sequential(OrderedDict([
            ('conv17_1x1', Conv2d(in_channels=128, out_channels=64, kernel_size=1)),
            ('conv17_1x1/relu', ReLU()),
            ('conv17_3x3', SeperableConv2d(in_channels=64, out_channels=128, kernel_size=3, stride=2, padding=1, name='conv17_3x3'))
            ])
        )
    ])
    ...
    regression_headers = ModuleList([
        ...
        SeperableConv2d(in_channels=256, out_channels=num_boxes * 4, kernel_size=3, stride=1, padding=1, name='loc_4'),
        SeperableConv2d(in_channels=128, out_channels=num_boxes * 4, kernel_size=3, stride=1, padding=1, name='loc_5'),
        Conv_2d(in_channels=128, out_channels=num_boxes * 4, kernel_size=1, stride=1, padding=0, name='loc_6'),
    ])
    ...
    classification_headers = ModuleList([
        ...
        SeperableConv2d(in_channels=256, out_channels=num_boxes * num_classes, kernel_size=3, stride=1, padding=1, name='cls_4'),
        SeperableConv2d(in_channels=128, out_channels=num_boxes * num_classes, kernel_size=3, stride=1, padding=1, name='cls_5'),
        Conv_2d(in_channels=128, out_channels=num_boxes * num_classes, kernel_size=1, stride=1, padding=0, name='cls_6'),
    ])
