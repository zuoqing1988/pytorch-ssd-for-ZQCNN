...
def pth2onnx(config_file, in_file, out, num_valid_classes, with_softmax):
    ...
    # create ssd net
    model = create_ssd(net_type, use_gray, num_valid_classes, aspect_ratios, priors, center_variance, size_variance, is_test=False, with_softmax=with_softmax, device=torch.device("cpu"))
